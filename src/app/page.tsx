    ...
    <>
      ...
      <section className="relative w-full h-[75vh] min-h-[500px] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <div className="w-full h-full bg-[url('/bg.png')] bg-cover bg-center brightness-[0.85] saturate-[0.85]" />
        </div>
      ...
      <section className="py-16 md:py-24 bg-white text-center">
        <div className="max-w-7xl mx-auto px-6">
          <p className="text-2xl md:text-[28px] font-medium text-gray-900 leading-snug">
            Hace tu Cursos de RCP y DEA. El objetivo es que puedan adquirir las técnicas o maniobras que tienden a sustituir las funciones vitales<br className="hidden xl:block" />
            por un tiempo prudencial hasta que llegue ayuda avanzada para brindarle a la víctima una oportunidad de sobrevivir.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-20 bg-[#f9f9f9]">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-16 text-center">
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <Link href="/cursos/rcp-y-dea" className="bg-[#fc0000] text-white px-8 py-2.5 rounded-full font-bold text-sm tracking-wide hover:bg-red-700 transition">
              Consultar
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <Link href="/cursos/primeros-auxilios" className="bg-[#fc0000] text-white px-8 py-2.5 rounded-full font-bold text-sm tracking-wide hover:bg-red-700 transition">
              Consultar
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center h-full">
            ...
            <Link href="/cursos/rcp-dea-primeros-auxilios" className="bg-[#fc0000] text-white px-8 py-2.5 rounded-full font-bold text-sm tracking-wide hover:bg-red-700 transition">
              Consultar
            </Link>
          </div>
        </div>
